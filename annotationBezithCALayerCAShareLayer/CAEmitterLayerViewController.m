...
- (void)cance1{
    ...
    emitterLayer.emitterPosition = CGPointMake(rect.size.width / 2.f, - 20);
    [self setEmitterCell];
...
- (void)setEmitterCell {
    ...
    rainflake.contents        = (__bridge id)([UIImage imageNamed:@"mp_dingwei"].CGImage);
    ...
    snowflake.contents        = (__bridge id)([UIImage imageNamed:@"mp_lanya"].CGImage);
